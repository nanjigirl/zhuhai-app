...
var comm = Vue.extend({
    ...
    methods: {
        locate: function () {
            ...
            mapHelper.setCenter(117.81401031277977, 37.16232143616774, self.map, 18);
            mapHelper.addPoint(self.map, 117.81401031277977, 37.16232143616774, "./img/icon/position.png", {});
