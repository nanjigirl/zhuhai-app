...
//此功能对应的视图（html）
var template = require('./containerDeviceRelateType.html');
//用于获取token，url头部等
...
var comm = container.extend({
    ...
    data: function () {
        return {
            ...
            tableId: "tableDeviceRelateType",
            //表单（弹窗）id，同一页面如果有多个实体列表需要修改
            formId: "formDeviceRelateType",
            //当前设备类型id
