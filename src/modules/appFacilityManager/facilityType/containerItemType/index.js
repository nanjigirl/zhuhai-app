...
//此功能对应的视图（html）
var template = require('./containerItemType.html');
//用于获取token，url头部等
...
var comm = container.extend({
    ...
    methods: {
        getCustomQueryParam: function () {
            ...
            formData.deviceTypeId = this.currentDeviceTypeId;
        ...
        initContainer: function (vm) {
            this.init(vm, "/itemType", [{
                ...
                events: {
                    ...
                    'click .itemTypeField': function (e, value, row, index) {
                        this.vm.showItemTypeFieldList(e, value, row, index);
                    }.bind(this),
                },
                //操作类的内容
                formatter: function (value, row, index) {
                    return [
                        '<a class="itemTypeField" href="javascript:;">',
                        '监测项类型字段',
                        '</a>  ',
