...
var comm = Vue.extend({
    ...
    methods: {
        ...
        showSubLegend: function (index) {
            this.legendList[index].showIcon = !this.legendList[index].showIcon;
            if (this.legendList[index].showIcon) {
                eventHelper.emit('facility-checked', this.legendList[index]);
            } else {
                eventHelper.emit('facility-unchecked', this.legendList[index]);
